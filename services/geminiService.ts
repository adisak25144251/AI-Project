...
/**
 * Backward-compatible Gemini Service (ให้ตรงกับ components เดิม)
 * - ไม่ใช้ ChatSession (เพราะ @google/genai ไม่ export)
 * - ฟังก์ชันรับ string ได้ และคืน string เสมอ (setState(string) ผ่าน)
 */
...
export type ProjectInputs = {
  ...
  users: string;
  data?: string;
  constraints?: string; // component ของคุณส่งเป็น string
};
