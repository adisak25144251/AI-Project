import { TRACKS_CASES } from "../testcases";
import { test, gotoOK, clickTid, expectVisible, expectUrlContains, assertNoMissingI18nKeys } from "../helpers";

for (const c of TRACKS_CASES) {
